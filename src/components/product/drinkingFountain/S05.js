...
import product01 from '../../../assets/images/product/drinking/s05/product01.png';
import waterHeater_product01 from '../../../assets/images/product/drinking/s05/heater_product01.png';
import waterHeater_product02 from '../../../assets/images/product/drinking/s05/heater_product02.png';
  ...
  const productsWaterHeater = [
    {
      ...
      price: '170,000원',
      text: '임대시 보증금 : 30,000원/n월 4병 이상 음용 / 24개월 약정 기간',
    },
    {
      title: '화이트 원형',
      sub: '산뜻한 디자인의',
    ...
    },
    {
      ...
      price: '180,000원',
      text: '임대시 보증금 : 40,000원/n월 4병 이상 음용 / 24개월 약정 기간',
    },
    {
      title: '모던 블랙',
      sub: '슬림한 디자인의',
      ...
      price: '200,000원',
      text: '임대시 보증금 : 50,000원/n월 4병 이상 음용 / 24개월 약정 기간',
    },
  ];
  ...
  return (
    <div className={cx('container')}>
      <div className={cx('limiter')}>
        ...
        <Table table={table} />
        <Download title="맛있는샘물은 안심하고 드실 수 있습니다!" text="수질 성적 검사서" file="" />
