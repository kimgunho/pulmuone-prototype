        ...
        <div className={cx('limiter')}>
          ...
          <div className={cx('info')}>
            <div className={cx('text')}>
              ...
              <img className={cx('mobileIllust')} src={mobile_illust_s01} alt="" />
              <p className={cx('light')}>
                이는 대보 화강암이 비다공질 화강암으로, 기공이 적은 만큼 강수가 지층을 통과하는 시간이 길어 물과 암석과의 반응 시간 또한
                길어져 주요 미네랄 함량이 높기 때문입니다.
              </p>
              <img className={cx('mobileIllust')} src={mobile_illust_s02} alt="" />
              <p className={cx('light')}>
              ...
              <img className={cx('mobileIllust')} src={mobile_illust_s03} alt="" />
            </div>
            <div className={cx('text')}>
              <h3>40m 천연 모래필터</h3>
              ...
              <img className={cx('mobileIllust')} src={mobile_illust_s04} alt="" />
            </div>
            <div className={cx('text')}>
              <h4>2억년 동안 어떠한 지질학적 변화도 겪지 않은 촘촘하고 단단한 화강암반의 풍부한 미네랄을 오롯이 물에 담았습니다.</h4>
              <img className={cx('mobileIllust')} src={mobile_illust_s05} alt="" />
            </div>
          </div>
        </div>
      </div>
