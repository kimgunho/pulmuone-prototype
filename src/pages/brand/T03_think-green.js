    ...
    <div className={cx('container')}>
      ...
      <div className={cx(['section', 'top'])}>
        <div className={cx('limiter')}>
          <h3>
            탄소 배출량을 줄여
            <br /> 환경까지 생각하는 초경량 패키지
          </h3>
          <div className={cx('center')}>
            <div className={cx(['desc', 'fisrt'])}>
              <h4>
                <span className={cx('number')} />
                <span className={cx('title')}>초경량 용기</span>
              </h4>
              <p>
            ...
            <div className={cx(['desc', 'second'])}>
              <h4>
                <span className={cx('number')} />
                <span className={cx('title')}>초경량 뚜껑</span>
              </h4>
              <p>
                플라스틱 사용량 40% 저감
                <br /> (기존 자사 제품 대비)
            ...
            <div className={cx(['desc', 'third'])}>
              <h4>
                <span className={cx('number')} />
                <span className={cx('title')}>상표띠 제거</span>
              </h4>
              <p>
                비닐 사용량 15% 저감
                <br /> (기존 제품 1팩 기준)
          ...
          <div className={cx('text')}>
            <p>
              ...
              <br /> 나아가 2021년 2월 환경부와 ‘라벨 없는 투명 페트병 사용’에 대한 업무 협약을 체결하고, 6월 상표띠(라벨)을 제거한 제품을
              출시했습니다.
            </p>
            <p>
              출시 이후에도 무라벨 제품 전환율을 지속적으로 높여 나가고자 하며,
              <br /> 이와 같이 풀무원샘물은 소비자와 지구를 모두 건강하게 만들기 위해 꾸준히 노력하고 있습니다.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={cx(['section', 'bottom'])}>
        <div className={cx('limiter')}>
          ...
          <img src={recycle} alt="" />
          <p>
            풀무원샘물은 제품 용기의 경량화뿐만 아니라 제품이 생산되고 소비자가 소비한 후
            <br /> 재활용되는 모든 단계에서 탄소 배출량을 줄이고자 노력하고 있습니다.
            <br /> 이러한 환경을 생각하는 풀무원샘물의 연구와 노력은 지금도 쉬지 않고 계속되고 있습니다.
          </p>
        </div>
      </div>
    </div>
