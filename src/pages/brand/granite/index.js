...
import background from '../../../assets/images/brand/granite/background.jpg';
      ...
      <div className={cx('section')}>
        <div className={cx('limiter')}>
          <div className={cx('info')}>
            ...
            <div className={cx('text')}>
              <h3>40m 천연 모래필터</h3>
              <p>대보 화감암류의 풍화산물인 충적층이 널리 분포, 발달하여 천연 모래필터를 만들었습니다.</p>
              <p className={cx('light')}>
          ...
          <div ref={imageRef} className={cx('image')}>
            <div ref={maskRef} className={cx('draw')} style={{ backgroundImage: `url(${draw})` }} />
