...
import background from '../../../assets/images/product/routine/s01/background.jpg';
import leaf_left from '../../../assets/images/product/routine/s01/leaf_left.png';
  ...
  return (
    <>
      ...
      <div className={cx('inner')}>
        ...
        <p>
          풀무원샘물 워터루틴은 550여가지의 철저한 수질검사를 거친 안전한 제품으로
          <br />
          풀무원샘물 워터루틴과 함께 라면 언제 어디서나 쉽고 편리하게 하루 2L 건강한 수분 습관을 지킬 수 있습니다.
        </p>
      </div>
    </>
  );
